        ...
        <div className='container grid grid-cols-1 md:grid-cols-2 min-h-[500px] relative'>
            <div className='flex flex-col justify-center py-14 md:py-0 relative z-10'>
                <div className='text-center md:text-left space-y-6 lg:max-w-[400px]'>
                    ...
                    className='text-gray-400'>Healthy and yummy food for fresh morning
                        breakfast. Eat daily for 
                        good health and mind order now and get
            ...
            <div className='absolute top-14 md:top-0 right-1/2 blur-sm bg-opacity-80 rotate-[40deg]'>
                <motion.img
